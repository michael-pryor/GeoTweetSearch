                ...
                <div class="span12">
                    <div class="row-fluid">
                        <div class="span12">
                            ...
                            <p>You can read a comprehensive report on the project <a href="{{static_root}}/report.pdf">here</a>, and the full source code for the project is available <a href="https://github.com/michael-pryor/GeoTweetSearch">here</a>.</p>
                            <br>
